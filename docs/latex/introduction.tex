...
theoretical background, related work in physics-informed neural networks and
optimal control, they are rocket dynamics model and problem
formulation, describes the PINN architecture, training methodology,
and surrogate evaluation then describes the methodological workflow. 
Chapter~3 presents the results of the study. Chapter~4 discusses the findings 
and limitations of the study. Chapter~5 concludes the
